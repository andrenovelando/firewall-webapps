<?php
//rank
$rank = fopen("./data result/social network/facebook/rank.csv","r");
$jumlah=array();
$value=array();
while(! feof($rank))
  {
...
<div class="box">
  <div class="box-header with-border bg-black">
    <div class="btn-group">
      <button type="button" class="btn bg-black btn-flat">ALL</button>
  ...
  <div class="box-body">
    ...
    #graph-container {
      ...
      <div class="col-lg-4 col-xs-4">
        ...
        '; echo '<span class="progress-text">'.$tenHighestKeys[9-$i].'</span>'; echo '<span class="progress-number"><b>'.$value[$i].'</b></span>'; echo '
        <div class="progress sm">
          '; $persentase=($value[$i]/$value[0])* 100; echo '
          <div class="progress-bar progress-bar-red" style="width: '.$persentase.'%"></div>
          '; echo '
        </div>
      </div>
      '; } ?>
 ...
 */
 // these are just some preliminary settings 
   ...
   sigma.parsers.json(
  './data result/social network/facebook/data.json',
        s,
        function() {
